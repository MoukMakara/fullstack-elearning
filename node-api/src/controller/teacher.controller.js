...
const getList = async (req, res) => {
  ...
  // Validate and convert page to a number
  ...
  try {
    const sqlTotal = "SELECT COUNT(Id) AS totalRecords FROM teacher WHERE 1=1";
    const sql = "SELECT * FROM teacher WHERE 1=1";
    let sqlWhere = "";
    const sqlParm = {};
    ...
    const sqlOrder = " ORDER BY Id DESC";
    const pageSize = 10;
    const offset = (pageNumber - 1) * pageSize; // Ensure pageNumber is valid
