...
function AdminStudentPage() {
  ...
  const onFinish = async (item) => {
    const body = {
      ...
      IsActive: formTeacher.getFieldValue("Id") ? item.IsActive : 1,
    };
  ...
  return (
    <MainAdminPage loading={loading}>
      ...
      <Table
        ...
        columns={[
          ...
          },
          {
            ...
            title: "Gender",
            dataIndex: "Gender",
            render: (value, items, inde) =>
              value === null ? null : value === 1 ? "Male" : "Female",
          },
          {
            key: "Dob",
            title: "Dob",
      ...
      <Modal
        ...
        title={formTeacher.getFieldValue("Id") ? "Edit Student" : "New Student"}
        footer={null}
      >
        <Form
          form={formTeacher}
