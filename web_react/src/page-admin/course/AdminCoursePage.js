...
function AdminCoursePage() {
  ...
  const onClickBtnDelete = (item, index) => {
    Modal.confirm({
      ...
      cancelText: "No",
      onOk: async () => {
        const res = await request("course/" + item.Id, "delete", {
          OldImage: item.Image,
        });
        if (res) {
  ...
  return (
    <MainAdminPage loading={loading}>
      ...
      <Table
        ...
        columns={[
          ...
          },
          {
            ...
            title: "Image",
            dataIndex: "Image",
            align: "center", // Centers the content in the column
            render: (image) =>
              image ? (
                <Image
                ...
                <div className="w-[100px] h-[80px] bg-gray-200 flex items-center justify-center rounded-sm shadow">
      ...
      <Modal
        ...
        title={formRef.getFieldValue("Id") ? "Edit Course" : "New Course"}
        footer={null}
      >
        ...
        >
          ...
          <Form.Item
            label="IsActive"
            name="IsActive"
            rules={[{ required: "true", message: "Please fill in status!" }]}
          >
