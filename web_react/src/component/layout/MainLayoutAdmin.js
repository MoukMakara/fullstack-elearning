...
const MainLayoutAdmin = () => {
  ...
  const itemsMenuAll = [
    ...
    getItem("Setting", "/admin/setting", <CiSettings />, [
      getItem("Setting1", "3"),
      getItem("Setting2", "4"),
    ]),
  ];
          ...
          <div className={styles.headerContainter}>
            <div className={styles.hearderG1}>
              <div className={styles.logo}>
                <div style={{ color: "#FFFFFF" }}>MKR</div>
              </div>
              <div>
                <div className={styles.brandName}>Mouk Makara</div>
                <div className={styles.subBrandName}>Web Developer</div>
              </div>
            ...
            <div className={styles.hearderG2}>
              ...
              <div>
                <img
                  ...
                  src={require("../../assests/icon/Makara.jpg")}
                  alt=""
                />
              </div>
            </div>
